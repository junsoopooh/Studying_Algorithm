...
for i in range(n):
    print(i*4*'_'+sentence1)
    print(i*4*'_'+sentence2)
    print(i*4*'_'+sentence3)
    print(i*4*'_'+sentence4)
print((n)*4*'_'+sentence1)
print((n)*4*'_'+'"재귀함수는 자기 자신을 호출하는 함수라네"')

for i in range(n,-1,-1):
    print(i*4*'_'+"라고 답변하였지.")