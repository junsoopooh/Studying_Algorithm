...
- 9월 ~~20일~~ 27일 수요일 20주차 스터디(동탄)

## 공지사항(2023.09.18)

- 코딩테스트 일정으로 20주차 알고리즘 스터디는 1주 연기됩니다.<br>
- 당분간 이론공부는 혼자 진행할 예정입니다. 수학적인 내용이 많아 현재 우리 수준과 상황에서 시간을 크게 들일만큼 우선순위가 높지 않다고 판단했습니다. 진행상황은 공유하면서 후에 알고리즘 문제 풀이와 관련된 내용이 나오면 같이 진행하도록 하겠습니다.<br>
- 구글시트에 취업 공고 시트를 마련하였습니다. 공유할 공고가 있으면 형식에 맞게 공유합시다!<
...
- public으로 변경되었습니다. 취준 기간동안은 유지될 예정입니다.<br>
...
- 푼 문제들을 [블로그](https://junsoopooh.github.io/)에 정리하여 올리고 있으니 참고하실분은 하셔도 됩니다.<br>

- 첫 화면에서 상단 Study 게시판 선택 후 오른쪽 algorithm 카테고리 선택 하거나, 오른쪽 상단 돋보기 클릭 후 <u>문제 번호</u>를 통해 검색<br>
...
4. 올린 Pull Request는 월요일 모임 이후 merge한다.<br>
5. 매 주차 READMD.MD 를 만들어 가능한 상세하게 기록한다.(23.04.10)<br>
6. 개념 공부는 Introduction to Algorithms 3rd로 진행한다.<br>
7. ~~개념서 내 연습 문제는 꼭 풀어보고, 양이 적은 만큼 확실히 이해해야 한다.~~(23.08.06 폐지)<br>
8. 모르는 부분에 대해서도 명확한 질문이 가능하도록 준비하여야 한다.(23.04.17)<br>
9. 각 주차에 공통 공지사항인 README는 수정하지 않는다.(23.04.26)<br>
10. 인원 변동은 구성원 모두의 만장일치로 결정한다.(23.05.18) <br>
11. 스터디 모임은 매 주 수요일로 하되, 합의 하에 요일과 시간을 조절한다.(23.07.27)<br>
12. 회의에 참여하지 못하는 경우는 스스로 판단하여 구성원에게 통지한다.(23.07.27)<br><br>
13. 개념 공부는 자율적으로 진행한다.(23.09.07)
