...
_2023년 11월 1일에 시작된 파이썬 알고리즘 스터디_

## 일정

- 2023년 11월 8일 2기 첫 모임

## 공지사항(2023.11.03)

- 2023년 4월 3일에 시작한 1기는 2023년 10월 4일에 종료되었습니다.
- 2023년 11월 8일에 2기를 시작합니다.

## 변경점
- 이론 공부 폐지: <Introduction to Algorithms 3rd edition>는 더이상 진행하지 않습니다.
- 테스트: 매달 테스트를 통한 점검을 진행할 예정입니다. 
- 플랫폼 : 프로그래머스를 통해 공부를 진행할 예정입니다.
- 학습량 : 매주 5문제(Lv1 2문제 Lv2 3문제)로 고정됩니다.
<br><br>
...
- 푼 문제들을 [배준수 개인 블로그](https://junsoopooh.github.io/)에 정리하여 올리고 있으니 참고하실분은 하셔도 됩니다.<br>

- 블로그 첫 화면에서 상단 Study 게시판 선택 후 오른쪽 algorithm 카테고리 선택 하거나, 오른쪽 상단 돋보기 클릭 후 <u>문제 번호나 이름</u>을 통해 검색<br>
