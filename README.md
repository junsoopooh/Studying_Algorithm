...
- [서준택](https://github.com/Taek222) 무단 결석 1회<br>
...
- 2024년 5월 29일 14주차 회의(Zoom)

## 공지사항(2024.05.22)

- 리트코드 문제의 난이도를 높였습니다.<br>
- 다음주 5월 월간 챌린지 진행합니다.<br>
- 챌린지 문제는 백준 1개, 리트코드 1개입니다.<br>
  <br><br>
...
1. 매주 공지된 프로그래머스 3문제(Lv1 1문제, Lv2 2문제)와 리트코드 1문제를 풀어온다.<br>
...
11. 지각 3회, 결석 2회는 1회 무단 결석으로 간주한다.<br>
12. 4개월 내 무단 결석 3회는 강제퇴장 처리한다.<br>
