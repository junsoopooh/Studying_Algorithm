...
- 5월 19일 금요일 오전 10시 알고리즘 이론 스터디가 예정되어 있습니다.<br>

- 5월 24일 수요일 문제풀이 회의 때까지 추가적으로 week06/junsu/1182.py도 고쳐오기로 했습니다.<br>

- main branch에서는 아직 merge하지 않아 찾을 수 없습니다. 다음주에 할 예정이니 week06/junsu branch에서 찾아보세요. <br>

- 나만무 관련 아이디어를 공유할 폴더를 만들었습니다. 각자가 구상한 것에 대해 자유롭게 올리시면 됩니다.<br>
...
- <span style="color:white">힘들어서 집 나간 친구 빨리 돌아왔으면!</span><br><br>
***
=======
...
- private이기 때문에 우리 세명만 볼 수 있습니다.<span style="color:white">당분간은</span><br>
