...
- 9월 6일 수요일 18주차 스터디(동탄)


## 공지사항(2023.08.30)

- 개인적으로 혼자 푼 문제들은 구글 시트에 올려도 됩니다. 푸는건 자율입니다.
- 각자 개인 시트에 올려도 되고, 공통 시트에 올려도 됩니다.
- 푼 문제들을 제 개인 블로그에 정리하여 올리고 있으니 참고하실분은 하셔도 됩니다.
...
5. 매 주차 READMD.MD 를 만들어 가능한 상세하게 기록한다.(23.04.10 월요일)<br>
6. 개념 공부는 Introduction to Algorithms 3rd로 진행한다.<br>
7. ~~개념서 내 연습 문제는 꼭 풀어보고, 양이 적은 만큼 확실히 이해해야 한다.~~(23.08.06 폐지)<br>
8. 모르는 부분에 대해서도 명확한 질문이 가능하도록 준비하여야 한다.(23.04.17 월요일)<br>
9. 각 주차에 공통 공지사항인 README는 수정하지 않는다.(23.04.26 수요일)<br>
10. 인원 변동은 구성원 모두의 만장일치로 결정한다.(23.05.18 목요일) <br>
