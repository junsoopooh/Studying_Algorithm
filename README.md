...
- 7월 12일 수요일 오전 10시 알고리즘 문제풀이 스터디
- 7월 13일 목요일 정글 6기 과정 종료

## 공지사항(2023.07.09)

- 나만의 무기 갖기 프로젝트가 끝났습니다. 모두 수고 많으셨습니다. <br>
- 알고리즘 문제풀이는 11주차 진행중이었습니다.
- 알고리즘 이론은 8주차 2단원 종합문제 이후로 중단되었습니다.
- 우선 이번주는 수요일에 진행하던 문제풀이를 재개하고 다음주부터는 이론과 문제풀이를 병행하겠습니다. 
- 시간대와 요일에 대해 고민해주세요. 누군가 취업을 한다면 저녁이후로 바꾸어야 합니다.
- Zoom을 결제하던, Slack을 결제하던, 그 이외의 방법이던 앞으로의 진행 방식에 대해 결정이 필요합니다.
- 위 2 문제에 대해서는 수요일 모임에 최종적으로 결정하겠습니다.
