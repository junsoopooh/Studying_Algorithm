...
# 5월 29일 **<u>막내</u>** 지원 탄생일 

퀸갓엠퍼러제너럴충무공마제스티 서지원 양의 25번째 생일을 축하합니다!

### 😊😁😄😆🫡🤡🙌🐇🐰🎉🎂🎂🎂🎂

![img](week01/Junsu/cele.jpg)

![cele1](week01/Junsu/oscars-standing-ovation.gif)
...
- 5월 31일 수요일 8주차 알고리즘 문제풀이 스터디

## 공지사항(2023.05.28)

- 알고리즘 이론 스터디는 나만무 대비로 당분간 중단됩니다. <br>
- 5월 31일 수요일 문제풀이 회의 때까지 추가적으로 서지원의 1920 코드도 함수 정의 여부에 따른 수행시간 차이에 관해 공부해야 합니다.<br>
- 나만무 리더에 지원했습니다만, 추가적인 아이디어는 여전히 필요합니다. 계속해서 고민해서 자유롭게 올립시다!<br>
- 좋은 아이디어는 긴 고민 끝에 나오는 1가지가 아니라 최대한 많이 쏟아내어 나온 후보지에서 고른 마지막 1가지입니다. <br>
- 숙제 문제를 다 풀었다면 추가적으로 다른 플랫폼에서도 풀어봅시다.<br>
***
...
## 안내사항
- 매주 수요일 회의가 끝나면 각 주차에 해당하는 폴더를 만들 예정입니다.<br>
...
- private이기 때문에 우리 세명만 볼 수 있습니다.<br>
...
4. 문제 풀이 회의는 매주 수요일 오전 10시이다.<br>
...
11. 각 주차에 공통 공지사항인 README는 수정하지 않는다.(23.04.26 수요일)<br>
12. 인원 변동은 구성원 모두의 만장일치로 결정한다.(23.05.18 목요일) <br><br>
